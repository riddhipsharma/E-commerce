<?php
  include 'action_manager_elect.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Manager-Electronics</title>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <form action="action_manager_elect.php" method="post" enctype="multipart/form-data">
      ...
      <div class="col-md-8">
        <?php
          $query = 'SELECT P_id,Cat_id,P_image,P_name,Price FROM product where Cat_id like "13%"';
        ...
        <table class="table table-hover" id="data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?= $row['Price']; ?></td>
              <td>
                <a href="action_manager_elect.php?delete=<?= $row['P_id']; ?>" class="badge badge-danger p-2" onclick="return confirm('Do you want delete this record?');">Delete</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
