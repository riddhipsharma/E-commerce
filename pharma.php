...
<html lang="en" dir="ltr">
  <head>
    ...
    <link ref="clothes_style.css" rel="stylesheet">
    <link rel="stylesheet" href="clothtest.css">
    <link rel="stylesheet" href="clothes_style.css">
  ...
  <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.min.css' />
    <title>E-Commerce~Pharmacy</title>
  </head>
  <body>
  <nav class="navbar  sticky-top navbar-expand-md navbar-light" style="background-color:#B3DCC3" >
    ...
    <a href="pharma.php">Syrups</a>
    <a href="capsule.php">Capsule</a>
    <a href="tablet.php">Tablet</a>
    <a href="ointment.php">ointment</a>
    </div>
    <div id="main">
...
<div class="container">
    ...
    <div class="row mt-2 pb-3">
      <?php
  			include 'config.php';
  			$stmt = $conn->prepare('SELECT * FROM product where cat_id="1101"');
  			$stmt->execute();
