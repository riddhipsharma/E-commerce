...
<html lang="en" dir="ltr">
  <head>
   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <title>E-Commerce~Bottoms</title>
  </head>
  <body>
...
<section>
  ...
  <div id="main">
    ...
    <br>
          ...
          <div class="row">
            <div class="col-lg-3">
              <img src="images/clothes/bottom/pinkjoggers.png" alt="">
              <a href="bottom1.html">
              <h4>Off Shoulder Top</h4></a>
              <div class="rating">
            ...
            <div class="col-lg-3">
              <img src="images/clothes/bottom/floralprintleggings.png" alt="">
              <a href="bottom2.html">
              <h4>Floral Print Leggings</h4></a>
              <div class="rating">
               <i class="fa fa-star"></i>
               <i class="fa fa-star"></i>
               <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3">
              <img src="images/clothes/bottom/blueprintedharempanta.png" alt="">
              <h4>Blue Harem Pants</h4>
              <div class="rating">
               <i class="fa fa-star"></i>
               <i class="fa fa-star"></i>
               <i class="fa fa-star"></i>
            ...
            <div class="col-lg-3">
              <img src="images/clothes/bottom/bluelongskirt.png" alt="">
              <h4>Blue Long Skirt</h4>
              <div class="rating">
               <i class="fa fa-star"></i>
               <i class="fa fa-star"></i>
               <i class="fa fa-star-o"></i>
            ...
            <div class="col-lg-3">
              <img src="images/clothes/bottom/bluejeans.png" alt="">
              <h4>Blue Jeans </h4>
              <div class="rating">
               <i class="fa fa-star"></i>
               <i class="fa fa-star"></i>
